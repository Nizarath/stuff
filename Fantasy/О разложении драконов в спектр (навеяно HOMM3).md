...
#### Взаимосвязь между разнообразием драконов и спектрами излучения

Внимание, вопрос: _что общего между левым и правым?_ :)\
(аналогии между спином или зарядом элементарных частиц и тем, "в какую сторону смотрит дракон", это что-то куда более
частное и обязанное специфике скриншота, тут речь о достаточно глобальной вещи и ее дальнейшем развитии, в привязке к описанному
выше)\
...
### TODO
- Дописать самое основное (о чем речь собственно)
- Возможно, заменить введение ссылкой на ролик Хуторянского (ибо он лучше всех передал абсолютно все, 
включая корректные направления, и полностью избежав при этом всего лишнего в физике, с одновременной эстетикой и 
даже некоторой эротичностью).
- Дописать про принципы (как сочетаемое, так и подряд, в т.ч. как пример)
