...
Другой ключевой пример -- усилие (не лишь волевое) при создании Паттерна Корвина, которое не сколько подарило новые способности (как при прохождении имеющегося), а создало новую мультивселенную. 
...
Все Patterns (Пути/Лабиринты/Образы — не воспринимаю такой перевод, но я бы назвал их Patherns, как паттерн + путь, статика + динамика) несмотря на некую схожесть совсем разные ассоциации и интерес вызывают, разные симпатии, вот примерно так, если описывать лоскутно:
...
### Дополнительные замечания, сравнения и аналогии
...
- P.S. Интересно, что похожая на ситуацию с Черной Дорогой (в силу определенной степени архетипичности) тематика была задействована в Сильмариллионе Толкиена -- я встречал кардинально 
...
- сравнение с Толкиеновской Аинулиндалэ
...
- принцип 16 (мой) -- временной крюк Оберона, задействующие гигантское количество информации, а так стрела времени во всех мирах в целом выделена,
  несмотря на разный ход в них (сродни разного ходу в разных ИСО в одном земном в силу инвариантности ур. Максвелла).
  С другой стороны сам вопрос тогда становится бессмысленным -- если из-за самой множественности миров все события происходят где-то (* хз, так ли это
  у Желязны) -- то "возврат в прошлое", т.е. статистически маловероятное банальное проигрывание тех же картинок в обратном порядке перед глазами
  (именно в этом смысле 2ЗТ задает понятие времени, а другие законы на Земле его вообще не содержат) -- есть в другом мире, т.е. это как
  "КМ-компенсация для эффектов 2ЗТ" (хз, есть ли такое в реальности).
  С другой стороны, тут технически реально отделить, что это не совсем "возврат в прошлое", т.к. другой мир никуда не девается.
  Некая выделенность направления времени тут есть, это сам сюжет цикла.
