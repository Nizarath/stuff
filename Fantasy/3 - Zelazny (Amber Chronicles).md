...
С другой стороны, мне малоинтересны именно _литературные_ моменты и принципы, сами ожидания от "формата книг", потому я вряд ли писал бы последние, а скорее занимался проектированием и генерацией материала, будь то книги или даже музыкальные рок-оперы (и "Пока и привет, как всегда" -- было бы хорошим названием для 
рок-оперы именно по Амберу, так же как и "Пока и привет, как всегда?").
